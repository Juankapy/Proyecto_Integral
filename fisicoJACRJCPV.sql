...
CREATE TABLE Notificacion (
    ...
    Estado VARCHAR2(10) DEFAULT 'No Le�da' CHECK (Estado IN ('Le�da', 'No Le�da'))
);

-- Relaci�n  Notificaciones y Usuarios
...
VALUES (
    1, TO_DATE('2025-05-10', 'YYYY-MM-DD'), 'Tiene una nueva cita programada.', 'No Le�da'
);
